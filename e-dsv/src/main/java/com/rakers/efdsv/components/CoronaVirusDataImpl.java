...
import com.rakers.efdsv.models.CoronaStateModel;
import com.rakers.efdsv.services.CoronaVirusDataService;
...
public class CoronaVirusDataImpl implements CoronaVirusData, Constants {
    ...
    public void setData(String uri, boolean isSyn) {
        newStats = new TreeMap<>();
        for (Iterator<CSVRecord> it = dataService.parseCSVIterator(uri, isSyn); it.hasNext(); ) {
    ...
    public void setDeathData(String uri, boolean isSyn) {
        for (Iterator<CSVRecord> it = dataService.parseCSVIterator(uri, isSyn); it.hasNext(); ) {
            CSVRecord record = it.next();
